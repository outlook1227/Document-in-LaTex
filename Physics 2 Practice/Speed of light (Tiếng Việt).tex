...
\begin{document}
	...
	\begin{table}[H]\centering\setlength\tabcolsep{12.5pt}\renewcommand\arraystretch{1.25}
		\noindent\makebox[\textwidth]{%
			\begin{tabular}{|l|*{3}{c|}}
				\hline
				\diagbox[width=\dimexpr \textwidth/8+2\tabcolsep\relax, height=1cm]{t(ns)}{S(m)}
				& 14 & 18 & 22 \\
				\hline
				1 & 44.8& 58.0 & 69.5 \\
				\hline
				...
				5 & 45.0 & 59.5 & 72.0 \\
				\hline
				\[t = \overline t  + \overline {\Delta t} (s)\]  & \[t_1 = 44.86 \pm 0.51\] &\[t_2 = 59.82 \pm 0.86\]& \[t_3 = 70.96 \pm 0.93\] \\
				\hline
			\end{tabular}
		}%
	\end{table}
	...
	\begin{table}[H]\centering\setlength\tabcolsep{12.5pt}\renewcommand\arraystretch{1.25}
		\noindent\makebox[\textwidth]{%
			\begin{tabular}{|l|*{3}{c|}}
				\hline
				\diagbox[width=\dimexpr \textwidth/8+3\tabcolsep\relax, height=1cm]{\[\Delta t(ns)\]}{\[\Delta S\](m)}
				& 4 & 8 & 12 \\
				\hline
				1 & 14.3 & 26.1 & 40.5 \\
				\hline
				...
				5 & 16.0 & 28.8 & 39.5 \\
				\hline
				\[\Delta t = \overline {\Delta t}  \pm \Delta \overline {\Delta t} \]  & \[\Delta {t_1} = 14.62 \pm 0.82\] &\[\Delta {t_2}= 27.20 \pm 1.00\]& \[\Delta {t_3}= 40.78 \pm 0.94\] \\
				\hline
			\end{tabular}
		}%
	\end{table}
